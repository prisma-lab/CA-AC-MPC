...
class BasePolicy(BaseModel, ABC):
    ...
    def predict(
        ...
        with th.no_grad():
            actions = self._predict(observation, drone_state_th, deterministic=deterministic)
...
class ActorCriticPolicy(BasePolicy):
    ...
    def _predict(self, observation: th.Tensor, state: th.Tensor, deterministic: bool = False) -> th.Tensor:
        """
        Get the action according to the policy for a given observation.
    ...
    def evaluate_actions(self, obs: th.Tensor, actions: th.Tensor, states: th.Tensor) -> Tuple[th.Tensor, th.Tensor, Optional[th.Tensor]]:
        """
    ...
    def get_distribution(self, obs: th.Tensor, state: th.Tensor) -> Distribution:
        """
